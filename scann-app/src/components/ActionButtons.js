...
function ActionButtons({ image, onTakePicture, onLoadPicture, onConfirmPicture, onDiscardPicture, onEditPicture }) {
  return (
    <div className="button-row">
      ...
      {image && <button onClick={onEditPicture}>Edit Picture</button>}
    </div>
  );
}
